                ...
                <section id="hero" className="text-gray-700 body-font bg-gray-100">
                    <div className="container mx-auto flex px-5 py-12 items-end space-x-8">
                        ...
                        <div className="lg:w-2/3 w-full h-fit flex flex-col justify-end">
                            <h1 className="title-font sm:text-5xl text-3xl mb-4 font-medium text-gray-900">Hi, I'm Leonard</h1>
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="#interests" className="text-gray-800 hover:text-gray-600 mx-4 sm:mx-6">
                                Interests
                                <div className="h-1 bg-indigo-500 rounded"></div>
                            </a>
                            <a href="#content" className="text-gray-800 hover:text-gray-600 mx-4 sm:mx-6">
                                Content
                                <div className="h-1 bg-indigo-500 rounded"></div>
                            </a>
                            ...
                            <a href="#contact" className="text-gray-800 hover:text-gray-600 mx-4 sm:mx-6">
                                Contact
                                <div className="h-1 bg-indigo-500 rounded"></div>
                            </a>
                        </div>
