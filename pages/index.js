      ...
      <div className="flex justify-start">
        ...
        <a>$ </a>
          <div className='cursor'>
            ...
            <input autoComplete='false' id='command' value={command} className='bg-black font-bold' type='text' style={{outline: 'none', width: '100%'}} onChange={(e)=>{setCommand(e.target.value.toLowerCase())}} onBlur={handleBlur}/>
            </form>
